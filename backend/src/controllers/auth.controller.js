...
var register = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, username, password, email, userFound, hashedPassword, newUser, userSaved, token, err_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                userFound = _b.sent();
                if (userFound) {
                    return [2 /*return*/, res.status(400).json(["The email is already in use"])];
                }
            ...
            case 4:
                userSaved = _b.sent();
                token = (0, jwt_1.createToken)({ id: userSaved._id });
                res.cookie("token", token);
                return [2 /*return*/, res.json(userSaved)];
            case 5:
                err_1 = _b.sent();
...
var login = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, userFound, passwordMatch, _b, token, error_1;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 4:
                ...
                token = (0, jwt_1.createToken)({ id: userFound._id });
                res.cookie("token", token);
                res.json(userFound);
                return [3 /*break*/, 6];
            case 5:
